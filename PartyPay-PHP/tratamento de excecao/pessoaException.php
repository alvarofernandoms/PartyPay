...
/**
 * Description of pessoaException
 *
 * @author Fagner-note
 */
class pessoaException {
	...
	function mensagens($num, $campo, $max, $min) {
		...
		$this->msg[5] = "Preencha o campo ".$campo." com numeros <br />"; // APENAS NUMEROS
		$this->msg[6] = "Preencha o campo ".$campo." <br />"; // CAMPO VAZIO
                $this->msg[7] = "O ".$campo." deve ter no máximo ".$max." caracteres <br />"; // MÁXIMO DE CARACTERES
		$this->msg[8] = "O ".$campo." deve ter no mínimo ".$min." caracteres <br />"; // MÍNIMO DE CARACTERES
